...
```text
to-java.xsl              34834  30.50%
classes.xsl              33288  29.14%
set-locators.xsl         11481  10.05%
set-original-names.xsl   7842   6.87%
attrs.xsl                6127   5.36%
data.xsl                 5666   4.96%
package.xsl              5047   4.42%
anonymous-to-nested.xsl  5002   4.38%
tests.xsl                4938   4.32%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-07-22 at 10:14,
on Linux with 4 CPUs.
The total is 114225 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/29910498133
